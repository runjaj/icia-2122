...
MethodInstance for Main.workspace#4.double(::Dict{Symbol, AbstractFloat}, ::Symbol)
  from double(mapping, key::Symbol) in Main.workspace#4 at /home/runner/work/icia-2122/icia-2122/tutorials/benchmarking.jl#==#3f0e2049-8597-4dac-b499-4d7a8a35978e:1
Arguments
...
BenchmarkTools.Trial: 10000 samples with 991 evaluations.
 Range (min … max):   42.784 ns … 28.336 μs  ┊ GC (min … max): 0.00% … 0.00%
 Time  (median):      44.399 ns              ┊ GC (median):    0.00%
 Time  (mean ± σ):   124.488 ns ±  1.066 μs  ┊ GC (mean ± σ):  0.43% ± 1.66%

      ▄█                                                        
  ▂▂▃███▇▅▃▂▂▂▂▂▂▂▃▃▄▄▃▃▂▂▂▃▃▅▄▄▄▃▃▃▃▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▁▂▂▂▂▂▂▁▂ ▃
  42.8 ns         Histogram: frequency by time         58.2 ns <
...
BenchmarkTools.Trial: 10000 samples with 996 evaluations.
 Range (min … max):  21.988 ns …  16.124 μs  ┊ GC (min … max): 0.00% … 0.00%
 Time  (median):     23.895 ns               ┊ GC (median):    0.00%
 Time  (mean ± σ):   54.956 ns ± 558.600 ns  ┊ GC (mean ± σ):  2.54% ± 1.70%

        ▁▆█▄                                                    
  ▁▁▁▂▃▆█████▅▃▂▁▁▁▁▁▁▁▂▂▂▂▂▂▂▂▁▂▁▁▂▂▂▃▃▄▃▃▃▃▃▂▂▂▂▂▂▁▁▁▁▁▁▁▁▁▁ ▂
  22 ns           Histogram: frequency by time         33.6 ns <
